<template>
    ...
    <div
        class="w-full p-6 m-auto bg-white border-t border-yellow-500 rounded shadow-lg shadow-purple-800/50 lg:max-w-md">
        <h1 class="text-3xl font-semibold text-center text-purple-700"><img src="/ED.png" alt=""></h1>
        ...
        <p class="mt-8 text-xs font-light text-center text-gray-700"> Don't have an account? <a href="#"
                class="font-medium text-yellow-500  hover:underline">Sign up</a></p>
    </div>
</div>
</template>